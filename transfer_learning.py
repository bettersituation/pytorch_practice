...
if __name__ == '__main__':
    ...
    center1 = [0.485, 0.456, 0.406]
    center2 = [0.229, 0.224, 0.225]
    ...
    data_transforms = {
        'train': transforms.Compose([
            ...
            transforms.ToTensor(),
            transforms.Normalize(center1, center2)
        ]),
    ...
    def imshow(inp, title=None):
        ...
        mean = np.array(center1)
        std = np.array(center2)
        inp = std * inp + mean
        inp = np.clip(inp, 0, 1)
        plt.imshow(inp)
    ...
    def train_model(model, criterion, optimizer, scheduler, num_epochs):
        ...
        print('training time: {:.2f}s'.format(time_elapsed))
